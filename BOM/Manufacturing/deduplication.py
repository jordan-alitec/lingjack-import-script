...
# --- CONFIG ---
FILE_PATH = "Manufacturing Order.xlsx"   # your excel file
SHEET_NAME = "Manufacturing Order (mrp.produc"      # sheet to work oner
COL_E = 2                  # column E index
COL_A = 5                  # column A index
# --------------
