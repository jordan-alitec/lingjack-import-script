...
class TierValidation(models.AbstractModel):
    ...
    def _validate_tier(self, tiers=False):
        ...
        reviews = self.review_ids.filtered(lambda r: r.status == "approved" and r.is_processed == False)
    ...
    def _rejected_tier(self, tiers=False):
        ...
        reviews = self.review_ids.filtered(lambda r: r.status == "rejected" and r.is_processed == False)
