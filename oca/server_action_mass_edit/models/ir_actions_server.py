...
class IrActionsServer(models.Model):
    ...
    is_sudo = fields.Boolean(
        string="Execute with Elevated Privileges",
        default=False,
        copy=False,
        tracking=True,
        help="If enabled, this mass edit action will be executed with elevated privileges (sudo). "
             "This allows bypassing access rights and security rules. "
             "Use with caution as it may lead to security vulnerabilities.",
    )
